<div id="booking-form" 
    x-data="{}" 
    x-on:scroll-to-booking.window="document.getElementById('booking-form').scrollIntoView({ behavior: 'smooth' })"
    class="max-w-2xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-md scroll-mt-24">
    <!-- Stepper Header -->
    <div class="mb-8">
